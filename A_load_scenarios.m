...
if compare==1
    Bind=ones(1,s); %prepare index vector of base experiment
    base_label=''; %prepare label of base experiment
    for i=1:1:numel(base(:,1));
        ...
        Bind=Bind.*B_temp'; %index vector of base experiment
        base_label=[base_label, ' ', base{i,2}, base{i,4}]; %label of base experiment
    end
end
