...
for n=1:1:P1_dim; %number of values for first scenario parameter
    for p=1:1:P2_dim; %number of values for second scenario parameter
     ...
     lm = fitglm(tbl,'Y ~ trap + repellent + trap:repellent', 'Distribution', 'poisson');
...
print(figure(1), '-dpdf', 'C:\Users\denzad\Documents\3640_LSTM Push Pull_Saddler_serversync\3.b Modelling\Preliminary OpenMalaria\Preliminary_Analysis\plots\Rusinga_15\Rusinga15_simEIR_logtransform_logscale_preintervEIR100and200_2019_2020_allages_glmpoisson.pdf');
